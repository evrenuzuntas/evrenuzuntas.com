...
export const tr: Translations = {
  ...
  bentoOverrides: {
    ...
    "youtube-4": { label: "@evoloper YouTube kanalıma git" },
    "youtube-5": { label: "@evoloper YouTube kanalıma git" },
    "youtube-6": { label: "@evoloper YouTube kanalıma git" },
    "youtube-7": { label: "@evoloper YouTube kanalıma git" },
    "youtube-subs-count": { label: "Abone" },
    "youtube-view": { label: "İzlenme" },
    "youtube-hours": { label: "İzlenme süresi (saat)" },
  },
};
